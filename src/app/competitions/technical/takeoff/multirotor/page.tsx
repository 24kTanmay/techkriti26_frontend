...
export default function MultirotorPage() {
  ...
  return (
    <div className="iarc-terminal-page">
      <StarBackgroundViewport mode="rise" count={200} canvasId="star-canvas-multirotor" />
      ...
      <div className="iarc-main-container">
        <div className="header-section-iarc">
          <span className="breadcrumb-iarc">Technical / Takeoff / TK-02</span>
          <h1 className="page-title-iarc"><span>MULTIROTOR</span></h1>
        </div>
        ...
        <div className="terminal-panel">
          <div className="panel-image-iarc">
            <div 
              ...
              style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1473968512647-3e44a224fe8f?q=80&w=2000&auto=format&fit=crop")' }}
            />
            ...
            <div className="panes-container-iarc" role="tabpanel">
              ...
              <div className={`tab-pane-iarc ${activeTab === 'problem' ? 'active' : ''}`}>
                <div>
                  ...
                  <div className="download-card-iarc" role="button" tabIndex={0} aria-label="Download Multirotor specs PDF">
                    <div className="down-text-iarc">
                      <h4>Multirotor_Challenge_v1.pdf</h4>
                      <p>Task Specs • 1.9 MB</p>
                    </div>
              ...
              <div className={`tab-pane-iarc ${activeTab === 'contacts' ? 'active' : ''}`}>
                <div>
                  <p className="pane-text-iarc">For technical queries regarding sensor integration or stability tuning, reach out to the Multirotor coordinators.</p>

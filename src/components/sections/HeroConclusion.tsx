...
export default function HeroConclusion() {
  return (
    <section className="relative h-screen z-[70] flex flex-col items-center justify-center text-center px-6 pb-20 overflow-hidden bg-transparent text-white">
      ...
      <div className="absolute bottom-12 w-full max-w-7xl z-20 px-12 space-y-4">
        <div 
          className="group/footer flex flex-col md:flex-row items-center rounded-[100px] border border-white/10 backdrop-blur-[50px] px-16 py-12 transition-all duration-500 hover:border-white/20"
          style={{
        ...
        <p className="copyright mt-[200px] text-center text-[10px] font-mono tracking-[0.4em] text-gray-400 uppercase">
